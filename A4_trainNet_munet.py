...
net = mUNet(in_channels=1, n_classes=nums_class, feature_scale=1).cuda()
...
for epoch in range(epoches):
    ...
    if val_mIOU > metric:
        metric = val_mIOU
        torch.save(net.state_dict(), '/home/cyyan/projects/ISICDM2019/model2D/mUNet_%d.pkl'%(int(metric*10000)))