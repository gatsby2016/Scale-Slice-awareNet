...
root = '/home/cyyan/santi/MRI/data/25D/'
train_loader, val_loader, train_nums, val_nums = reach_data(root, batch_size=12)

# net = UNet(in_channels=3, n_classes=nums_class, feature_scale=1).cuda()
...
for epoch in range(epoches):
    ...
    if val_mIOU > metric:
        metric = val_mIOU
        torch.save(net.state_dict(), '/home/cyyan/santi/MRI/model/fcn_%d.pkl'%(int(metric*10000)))