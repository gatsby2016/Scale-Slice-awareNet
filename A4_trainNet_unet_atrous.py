...
train_loader, val_loader, train_nums, val_nums = reach_data(root, batch_size=4)

net = A2UNet(in_channels=1, n_classes=nums_class, feature_scale=1).cuda()
...
for epoch in range(epoches):
    ...
    if val_mIOU > metric:
        metric = val_mIOU
        torch.save(net.state_dict(), '/home/cyyan/projects/ISICDM2019/model2D/major_revison_a2unet_%d.pkl'%(int(metric*10000)))
